...
export class TimeFlowCardEditor extends LitElement {
    ...
    private _computeHelper(schema: any): string {
        const helpers: Record<string, string> = {
            ...
            'progress_steps': 'Dynamic configuration changes based on percentage thresholds. Define in YAML mode as array of objects. Supported properties: progress_color, background_color, text_color. Example: [{from: 0, progress_color: "#00ff00", background_color: "#000"}, {from: 75, progress_color: "#ff0000", background_color: "#300", text_color: "#fff"}]. Properties override corresponding base config when threshold is reached.',
